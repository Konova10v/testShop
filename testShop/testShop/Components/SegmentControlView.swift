...
public struct SegmentControlView: View {
    ...
    private func segmentItemView(for index: Int) -> some View {
        ...
        return Text(items[index])
            .font(isSelected ? .custom(Resources.Fonts.bold.rawValue, size: 20) : .custom(Resources.Fonts.regular.rawValue, size: 20))
            .foregroundColor(isSelected ? Resources.Colors.baseTextColor : .gray)
